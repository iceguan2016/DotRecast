...
namespace Navmesh.Core
{
	...
	public struct IntRect
	{
		...
		//public void DebugDraw(UnityEngine.Matrix4x4 matrix, UnityEngine.Color col)
		//{
		//	UnityEngine.Vector3 p1 = matrix.MultiplyPoint3x4(new UnityEngine.Vector3(xmin, 0, ymin));
		//	UnityEngine.Vector3 p2 = matrix.MultiplyPoint3x4(new UnityEngine.Vector3(xmin, 0, ymax));
		//	UnityEngine.Vector3 p3 = matrix.MultiplyPoint3x4(new UnityEngine.Vector3(xmax, 0, ymax));
		//	UnityEngine.Vector3 p4 = matrix.MultiplyPoint3x4(new UnityEngine.Vector3(xmax, 0, ymin));

		//	UnityEngine.Debug.DrawLine(p1, p2, col);
		//	UnityEngine.Debug.DrawLine(p2, p3, col);
		//	UnityEngine.Debug.DrawLine(p3, p4, col);
		//	UnityEngine.Debug.DrawLine(p4, p1, col);
		//}
	}
}
