...
public sealed class HxArray<T> : global::haxe.lang.HxObject, global::HxArray
{
	
	static bool __hx_init_called = false;
	static HxArray() {
		if(global::HxArray<object>.__hx_init_called) return;
		global::HxArray<object>.__hx_init_called = true;
		unchecked{
			global::HxArray<object>.__hx_toString_depth = 0;
			global::HxArray<object>.__hx_defaultCapacity = 4;
		}
		
	}
	
	
	public HxArray(global::haxe.lang.EmptyObject empty) {
	}
	
	
	public HxArray(T[] native) {
		global::HxArray<object>.__hx_ctor__Array<T>(((global::HxArray<T>) (this) ), ((T[]) (native) ));
	}
	
	
	public HxArray() {
		global::HxArray<object>.__hx_ctor__Array<T>(((global::HxArray<T>) (this) ));
	}
	
	
	private static void __hx_ctor__Array<T_c>(global::HxArray<T_c> __hx_this, T_c[] native) {
		__hx_this.length = ( native as global::System.Array ).Length;
		__hx_this.__a = native;
	}
	
	
	private static void __hx_ctor__Array<T_c>(global::HxArray<T_c> __hx_this) {
		__hx_this.length = 0;
		__hx_this.__a = new T_c[0];
	}
	
	
	public static object __hx_cast<T_c_c>(global::HxArray me) {
	...
	public static global::HxArray<X> ofNative<X>(X[] native) {
		return new global::HxArray<X>(((X[]) (native) ));
	}
	
	
	public static global::HxArray<Y> alloc<Y>(int size) {
		return new global::HxArray<Y>(((Y[]) (new Y[size]) ));
	}
	...
	public object Array_cast<T_c>() {
		unchecked {
			...
			global::HxArray<T_c> new_me = new global::HxArray<T_c>(((global::haxe.lang.EmptyObject) (global::haxe.lang.EmptyObject.EMPTY) ));
	...
	public global::HxArray<T> concat(global::HxArray<T> a) {
		...
		return new global::HxArray<T>(((T[]) (retarr) ));
	}
		...
		unchecked {
			...
			while ((  ++ i < length )) {
				if (first) {
					...
					buf_b.Append(((string) (global::HxStd.@string(sep)) ));
				}
				
				buf_b.Append(((string) (global::HxStd.@string(global::haxe.lang.Runtime.genericCast<T>(this.__a[i]))) ));
			}
	...
	public global::HxArray<T> slice(int pos, global::haxe.lang.Null<int> end) {
		if (( pos < 0 )) {
			pos = ( this.length + pos );
			if (( pos < 0 )) {
				pos = 0;
	...
	public global::HxArray<T> splice(int pos, int len) {
		if (( len < 0 )) {
			return new global::HxArray<T>();
		}
		...
		global::HxArray<T> ret1 = new global::HxArray<T>(((T[]) (ret) ));
		int end = ( pos + len );
	...
	public string toString() {
		unchecked {
			if (( global::HxArray<object>.__hx_toString_depth >= 5 )) {
				return "...";
			}
			
			 ++ global::HxArray<object>.__hx_toString_depth;
			try {
	...
	public string __hx_toString() {
		...
		bool first = true;
		{
			...
			while (( _g < _g1 )) {
				...
				ret_b.Append(((string) (global::HxStd.@string(global::haxe.lang.Runtime.genericCast<T>(a[i]))) ));
			}
	...
	public global::HxArray<S> map<S>(global::haxe.lang.Function f) {
		global::HxArray<S> ret = new global::HxArray<S>(((S[]) (new S[this.length]) ));
		{
			int _g = 0;
			int _g1 = this.length;
			while (( _g < _g1 )) {
	...
	public global::HxArray<T> filter(global::haxe.lang.Function f) {
		global::HxArray<T> ret = new global::HxArray<T>(new T[]{});
		{
			int _g = 0;
			int _g1 = this.length;
			while (( _g < _g1 )) {
	...
	public global::haxe.iterators.ArrayIterator<T> iterator() {
		return new global::haxe.iterators.ArrayIterator<T>(((global::HxArray<T>) (this) ));
	}
	
	
	public global::haxe.iterators.ArrayKeyValueIterator<T> keyValueIterator() {
		return new global::haxe.iterators.ArrayKeyValueIterator<T>(((global::HxArray<T>) (this) ));
	}
	...
	public override object __hx_invokeField(string field, int hash, object[] dynargs) {
		unchecked {
			switch (hash) {
				...
				case 1204816148:
				{
					return this.concat(((global::HxArray<T>) (global::HxArray<object>.__hx_cast<T>(((global::HxArray) (dynargs[0]) ))) ));
				}
	...
	object global::HxArray.this[int key]{
		get{
...
#pragma warning disable 109, 114, 219, 429, 168, 162
[global::haxe.lang.GenericInterface(typeof(global::HxArray<object>))]
public interface HxArray : global::haxe.lang.IHxObject, global::haxe.lang.IGenericObject {
