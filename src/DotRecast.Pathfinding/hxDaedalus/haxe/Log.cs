...
namespace haxe {
	public class Log : global::haxe.lang.HxObject {
		...
		public static string formatOutput(object v, object infos) {
			string str = global::HxStd.@string(v);
			if (( infos == null )) {
				return str;
			}
			...
			if (( ((global::HxArray) (global::haxe.lang.Runtime.getField(infos, "customParams", 1830310359, true)) ) != null )) {
				int _g = 0;
				global::HxArray _g1 = ((global::HxArray) (global::haxe.lang.Runtime.getField(infos, "customParams", 1830310359, true)) );
				while (( _g < ((int) (global::haxe.lang.Runtime.getField_f(_g1, "length", 520590566, true)) ) )) {
					object v1 = _g1[_g];
					 ++ _g;
					str = global::haxe.lang.Runtime.concat(str, global::haxe.lang.Runtime.concat(", ", global::HxStd.@string(v1)));
				}
