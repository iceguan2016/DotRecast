...
namespace haxe.lang {
	public interface IHxObject {
		...
		void __hx_getFields(global::HxArray<string> baseArr);
...
namespace haxe.lang {
	public class HxObject : global::haxe.lang.IHxObject {
		...
		public virtual void __hx_getFields(global::HxArray<string> baseArr) {
		}
...
namespace haxe.lang {
	public class DynamicObject : global::haxe.lang.HxObject {
		...
		public virtual string __hx_toString() {
			...
			{
				int _g = 0;
				global::HxArray<string> _g1 = global::HxReflect.fields(this);
				while (( _g < _g1.length )) {
					string f = _g1[_g];
					 ++ _g;
					if (first) {
					...
					ret_b.Append(((string) (" ") ));
					ret_b.Append(((string) (global::HxStd.@string(f)) ));
					ret_b.Append(((string) (" : ") ));
					ret_b.Append(((string) (global::HxStd.@string(((object) (global::HxReflect.field(this, f)) ))) ));
				}
...
namespace haxe.lang {
	public class Enum {
		...
		protected static string paramsToString(string tag, object[] @params) {
			global::System.Text.StringBuilder ret_b = new global::System.Text.StringBuilder();
			ret_b.Append(((string) (global::HxStd.@string(tag)) ));
			ret_b.Append(((string) ("(") ));
			bool first = true;
			{
				int _g = 0;
				while (( _g < ( ((object[]) (@params) ) as global::System.Array ).Length )) {
					...
					ret_b.Append(((string) (global::HxStd.@string(((object) (p) ))) ));
				}
		...
		public virtual global::HxArray<object> getParams() {
			return new global::HxArray<object>(new object[]{});
		}
