	...
	public static object callField(haxe.lang.HxObject obj, string field, int fieldHash, object[] args)
	{
		...
		public static object plus(object v1, object v2) {
			if (( ( v1 is string ) || ( v2 is string ) )) {
				return global::haxe.lang.Runtime.concat(global::HxStd.@string(v1), global::HxStd.@string(v2));
			}
			...
			throw new global::System.ArgumentException(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("Cannot dynamically add ", global::HxStd.@string(v1)), " and "), global::HxStd.@string(v2)));
		}
		...
		public static object slowSetField(object obj, string field, object @value) {
			...
			if (( f != null )) {
				...
				if (( prop == null )) {
					...
					throw ((global::System.Exception) (global::haxe.Exception.thrown(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("Field \'", field), "\' not found for writing from Class "), global::HxStd.@string(t)))) );
				}
			...
			unchecked {
							...
							if (( ( @params as global::System.Array ).Length != length )) {
								...
								int crate = 0;
								{
									...
									while (( _g4 < _g5 )) {
										...
										string strParam = global::haxe.lang.Runtime.concat(global::HxStd.@string(param), "");
				...
				global::System.Reflection.ParameterInfo[] params1 = ((global::System.Reflection.MethodBase) (methods[0]) ).GetParameters();
				{
					...
					while (( _g8 < _g9 )) {
						...
						string strParam1 = global::haxe.lang.Runtime.concat(global::HxStd.@string(param1), "");
						object arg = oargs[i4];
		...
		public static object unbox(object dyn) {
			if (( ( dyn != null ) && (global::haxe.lang.Runtime.concat(global::HxStd.@string(dyn.GetType()), "")).StartsWith("haxe.lang.Null") )) {
		...
		public static object slowCallField(object obj, string field, object[] args) {
			...
			if (( last == 0 )) {
				throw ((global::System.Exception) (global::haxe.Exception.thrown(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("Method \"", field), "\" not found on type "), global::HxStd.@string(t)))) );
			}
