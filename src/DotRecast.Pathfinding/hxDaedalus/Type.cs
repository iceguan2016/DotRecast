...
public class HxType : global::haxe.lang.HxObject {
	
	public HxType(global::haxe.lang.EmptyObject empty) {
	}
	
	
	public HxType() {
		global::HxType.__hx_ctor__Type(this);
	}
	
	
	protected static void __hx_ctor__Type(global::HxType __hx_this) {
	}
	
	
	public static global::HxArray<string> getClassFields(global::System.Type c) {
		if (global::System.Object.ReferenceEquals(((object) (c) ), ((object) (typeof(string)) ))) {
			return new global::HxArray<string>(new string[]{"fromCharCode"});
		}
